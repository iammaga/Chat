<div class="flex-1 flex flex-col">
    <div class="p-4 border-b flex items-center justify-between"
        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <div class="text-sm" :class="isDarkMode ? 'text-zinc-400' : 'text-zinc-500'">Активен 2 мин назад</div>
            </div>
        </div>
    ...
    <div x-data="{
        ...
        <form @submit.prevent="sendMessage" class="flex items-center gap-2">
            {{--            <button type="button" class="p-2 rounded-full" :class="isDarkMode ? 'text-zinc-400 hover:text-white' : 'text-zinc-600 hover:text-zinc-950'">--}}
            {{--                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">--}}
